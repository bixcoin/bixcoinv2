...
static bool ipcScanCmd(int argc, char *argv[], bool fRelay)
{
    ...
    {
        if (boost::algorithm::istarts_with(argv[i], "bixcoin:"))
        {
            ...
            try {
                ...
                {
                    printf("Bixcoin main() - boost interprocess exception #%d: %s\n", ex.get_error_code(), ex.what());
                    break;
                }
            }
        }
...
static void ipcThread(void* pArg)
{
    ...
    printf("Bixcoin ipcThread exited\n");
}

static void ipcThread2(void* pArg)
{
    printf("Bixcoin ipcThread started\n");
...
void ipcInit(int argc, char *argv[])
{
    ...
    try {
        ...
        printf("Bixcoin ipcInit() - boost interprocess exception #%d: %s\n", ex.get_error_code(), ex.what());
        return;
    }
